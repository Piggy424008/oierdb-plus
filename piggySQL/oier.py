...
class OIer:
    ...
    def __get_json_records__(self):
        return [record.to_json_format(self.enroll_middle) for record in self.records]
    ...
    def to_json_format(self):
        return {
            ...
            "name": self.name,
            "gender": self.gender,
            "enroll_middle": self.enroll_middle,
            "OIerDB_score":  OIer.__float2p_format__(self.oierdb_score),
            "CCF_Score": OIer.__float2p_format__(float(self.ccf_score)),
            "CCF_level": self.ccf_level,
            "records": self.__get_json_records__()
        }
