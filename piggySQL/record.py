...
class Record:
    ...
    def to_json_format(self, ref):
        return {
            "contest": self.contest.id,
            "school": self.school.id,
            "score": Record.__score_format__(self.score),
            "rank": self.rank,
            "Province": Record.__province_format__(self.province),
            "level": Record.__award_level_format__(self.level)
        }
